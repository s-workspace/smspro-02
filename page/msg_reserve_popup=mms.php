   ...
   <div class="popup_wrap">
      ...
      <div class="popup_content">
         <div class="detail_top">
            ...
            <div class="detail_phone detail_mms">
               <div class="d_byte">
...
행복한 5월 되시길 기원합니다.</textarea>
         ...
         <div class="detail_table_top">
            ...
            <p>
               ...
               <a href="msg_reserve_edit=mms.php" onclick="window.open(this.href, '', 'left=560, top=300, width=660, height=400'); return false;"><img src="../images/popup/btn_reserve_modify.gif" alt=""></a>
            </p>
         </div>
