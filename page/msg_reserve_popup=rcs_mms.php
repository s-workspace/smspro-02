   ...
   <div class="popup_wrap">
      ...
      <div class="popup_content">
         <div class="detail_top">
            <div class="detail_con">
               <div class="detail_list">
                  <ul>
                     ...
                     <li><span><strong>전송유형</strong></span><strong class="t_blue">RCS(MMS) 1건</strong></li>
               ...
               <div class="reserve_notice" style="height: 125px;">
                  <ul>
            ...
            <div class="detail_phone detail_mms detail_rcs">
               <div class="d_byte">
...
행복한 5월 되시길 기원합니다.</textarea>
         ...
         <div class="detail_table_top">
            ...
            <p>
               ...
               <a href="msg_reserve_edit=rcs_mms.php" onclick="window.open(this.href, '', 'left=560, top=300, width=660, height=400'); return false;"><img src="../images/popup/btn_reserve_modify.gif" alt=""></a>
            </p>
         </div>
