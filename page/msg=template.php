      ...
      <div class="wrap">
         <div class="title_top">
            <ul>
               ...
               <li>|</li>
               <li class="this"><a href="msg=template.php">템플릿 전송</a></li>
               ...
               <div class="msg_content msg_write">
                  ...
                  <div class="msg_wbox">
                     ...
                     <div class="msg_table">
                        <i>
                           <div class="msg_tit">
                              <input type="text" placeholder="템플릿 제목(템플릿을 선택해 주세요.)" maxlength="8" readonly>
                           </div>
                           <div class="msg_text sms">
                              <h1 class="type01 none">(광고)</h1>
                              <textarea name="" id="text_box" placeholder="내용 입력
(템플릿을 선택해 주세요.)" readonly></textarea>
                              <h2 class="type01 none">무료수신거부 0808718744</h2>
                              <div class="t_byte">
                                 <b>0</b><span>/90자</span><h1 class="msg_t1">템플릿 전송</h1>
                              </div>
                           </div>
                        </i>
                        <div class="btn_box">
                     ...
                     <div class="msg_type_wrap">
                        ...
                        <div class="check_con mt20">
                           ...
                           <label for="msgSet03"><span>실패시 대체문자 전송</span></label>
...
- 이미지 업로드시 MMS로 자동 전환"></textarea>
                              <h2 class="type01 none">무료수신거부 0808718744</h2>
                              <div class="t_byte">
                                 <b>0</b><span>/90Byte</span><h1 class="msg_t1">SMS 단문</h1><h1 class="msg_t2">LMS 장문</h1><h1 class="msg_t3">MMS 이미지</h1>
                              </div>
                           </div>
                        </i>
                        <div class="btn_box">
