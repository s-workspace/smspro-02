                  ...
                  <div class="msg_wbox mt40">
                     <div class="rcs_box rcs_cell_box">
                        <div class="rcs_box_con">
                           <i>
                              <p>* 브랜드 선택</p>
                              <div class="select_box brand_sel" style="width: 490px; background-position: 460px center;">
                                 <span>브랜드 선택</span>
                                 <ul>
                        ...
                        <div class="rcs_box_con mt10">
                           <i>
                              <p>* 템플릿 속성</p>
                              <input type="text" value="타이틀 자유형 | 서술형(description)" readonly>
                           </i>
                        </div>
                        <div class="rcs_box_con mt10">
                           <i>
                                 ...
                                 <td style="padding-right:0;">
                                    <div class="cell_text_wrap flex5">
                                       <div class="cell_text_box">
                                          <input type="text" id="rcs_tit" placeholder="템플릿 제목 입력 (8자 이내)" maxlength="8">
                                       </div>
