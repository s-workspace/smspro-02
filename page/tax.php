    ...
    <div class="tax_box mt20">
      ...
      <div class="tax_box_right">
        ...
        <div class="tax_con mt10" id="document_con">
          <h1>
            <img src="../images/tax/document_tit01.png" alt="결제내역 증빙서류">
            <p>간편하게 증빙서류를 발급받으세요!</p>
          </h1>
          <ul>
            <li><a href="tax=invoice.php"><img src="../images/tax/document_con01.png" alt=""></a></li>
            <li><a href="tax=credit_card.php"><img src="../images/tax/document_con02.png" alt=""></a></li>
            <li><a href="https://www.nicepay.co.kr/cs/transInfo/phoneList.do" target="_blank"><img src="../images/tax/document_con03.png" alt=""></a></li>
          </ul>
        </div>
      </div>
    </div>
