      ...
      <div class="tax_box mt20">
        ...
        <div class="tax_box_right">
          ...
          <div class="tax_con mt10" id="document_con">
            <h1>
              <img src="../images/tax/document_tit02.png" alt="발급등록 정보확인">
              <p>사업자 회원등록은 사업자등록증 사본을 팩스로 전송해 주십시오!</p>
              <p>사업자 번호 등록이 안되시면, 세금계산서 출력은 불가합니다.</p>
              <!-- <p>고객님은 개인회원으로 영수증 발급만 가능하며, 사업자로 가입후 세금계산서 출력이 가능합니다.</p>
              <p>사업자로 전환하시려면 사업자등록증 사본을 팩스로 보내주시기 바랍니다.</p> -->
            </h1>
            ...
            <p class="mt10">
              <img src="../images/tax/document_info.png" alt="">
              <!-- ※ 본 회원정보는 smsmoa.com 사이트에 로그인하신 후 정보변경에서 수정이 가능합니다. -->
            </p>
          </div>
        </div>
      </div>
